...
**Software Engineer · Dev Team Lead · Open Source**
...
> **AI-Driven SDLC & agent-workflow runner** — declare your pipeline in `workspace.yaml` and drive **Claude** through every step, while the built-in **Monitor** tracks token usage, live agent observability, and session insights. Available for VS Code, Open VSX, and the terminal.

[![VS Code Marketplace](https://img.shields.io/visual-studio-marketplace/v/hueanmy.aidlc?style=flat-square&label=VS%20Code%20Marketplace&color=2b6cb0&logo=visualstudiocode&logoColor=white)](https://marketplace.visualstudio.com/items?itemName=hueanmy.aidlc)
[![Installs](https://img.shields.io/visual-studio-marketplace/i/hueanmy.aidlc?style=flat-square&label=installs&color=2b6cb0)](https://marketplace.visualstudio.com/items?itemName=hueanmy.aidlc)
[![Open VSX](https://img.shields.io/open-vsx/v/hueanmy/aidlc?style=flat-square&label=Open%20VSX&color=a259e6)](https://open-vsx.org/extension/hueanmy/aidlc)
[![npm](https://img.shields.io/npm/v/aidlc?style=flat-square&label=npm&color=cb3837&logo=npm&logoColor=white)](https://www.npmjs.com/package/aidlc)
[![GitHub](https://img.shields.io/badge/GitHub-aidlc--io%2Faidlc-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/aidlc-io/aidlc)

An ecosystem of AI-driven developer tools — **VS Code extension · CLI · terminal · test agent** — with **8,000+ installs**. I also ship open-source utilities for **Claude Code** workflows and write free guides on building with Claude. → Full details at **[hueanmy.github.io](https://hueanmy.github.io)**
